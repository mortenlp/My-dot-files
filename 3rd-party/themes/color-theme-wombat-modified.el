...
(defun color-theme-wombat-modified ()
  ...
  (color-theme-install
   `(color-theme-wombat
     ...
     (mode-line ((t (:background ,wombat-red-1 :foreground ,wombat-fg))))
     (mode-line-emphasis ((t (:bold t))))
     (mode-line-highlight ((t (:background ,wombat-orange :box nil))))
     (mode-line-inactive ((t (:background ,wombat-bg :box (:line-width 1 :color ,wombat-red-1 :style nil)))))
...
(provide 'color-theme-wombat-modified)
